...
name = 'cassan_32_48_510.det.lc.gz'  
...
#plt.plot(t,f,'r')
#plt.figure(2)
#plt.plot(t, (amp_ml/np.sqrt(2*pi*sigma))*np.exp(-((t-mean_ml)**2)/(2*(sigma_ml**2)))+fun(t0_ml, u0_ml, tE_ml,f_s_ml))
#plt.plot(t,f,'r')
#plt.figure(3)
#plt.plot(t, f-((amp_ml/np.sqrt(2*pi*sigma))*np.exp(-((t-mean_ml)**2)/(2*(sigma_ml**2)))+fun(t0_ml, u0_ml, tE_ml,f_s_ml)))
#plt.plot(t,f,'r')
plt.show()
